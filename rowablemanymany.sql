...
-- Started on 2021-04-01 13:20:53
...
--
-- TOC entry 202 (class 1259 OID 41529)
-- Name: boathouse; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.boathouse OWNER TO postgres;

--
-- TOC entry 203 (class 1259 OID 41535)
-- Name: Boathouse_ID_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public."Boathouse_ID_seq" OWNER TO postgres;

--
-- TOC entry 3019 (class 0 OID 0)
-- Dependencies: 203
-- Name: Boathouse_ID_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- TOC entry 201 (class 1259 OID 41331)
...
--
-- TOC entry 200 (class 1259 OID 41329)
...
--
-- TOC entry 204 (class 1259 OID 49471)
...
--
-- TOC entry 2863 (class 2604 OID 41544)
...
-- Dependencies: 202
-- Data for Name: boathouse; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3010 (class 0 OID 41331)
-- Dependencies: 201
...
1	test	$2b$12$dwn1k8ScJX59VzNjkuAuY.99.P5wnGNITyNTzWT567QV7eAJaqv1S	test@testuser.com	imperial	2021-03-29	t	\N	\N
\.


--
-- TOC entry 3013 (class 0 OID 49471)
-- Dependencies: 204
-- Data for Name: user_favorites; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.user_favorites (user_id, boathouse_id) FROM stdin;
\.
...
-- Dependencies: 203
-- Name: Boathouse_ID_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2874 (class 2606 OID 41546)
-- Name: boathouse Boathouse_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2868 (class 2606 OID 41344)
...
--
-- TOC entry 2870 (class 2606 OID 41340)
...
--
-- TOC entry 2872 (class 2606 OID 41342)
...
--
-- TOC entry 2875 (class 1259 OID 49485)
-- Name: fki_boathouse_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX fki_boathouse_id ON public.user_favorites USING btree (boathouse_id);


--
-- TOC entry 2876 (class 1259 OID 49479)
-- Name: fki_user_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX fki_user_id ON public.user_favorites USING btree (user_id);


--
-- TOC entry 2878 (class 2606 OID 49480)
-- Name: user_favorites boathouse_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_favorites
    ADD CONSTRAINT boathouse_id FOREIGN KEY (boathouse_id) REFERENCES public.boathouse(id) NOT VALID;


--
-- TOC entry 2877 (class 2606 OID 49474)
-- Name: user_favorites user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Completed on 2021-04-01 13:20:53
